...
import {
  Facebook, Instagram, Copy, Check, Hash, Link as LinkIcon,
} from "lucide-react";
...
export function SocialTeaserPreview({ articleTitle, articleUrl, featuredImage, excerpt }: SocialTeaserProps) {
  ...
  const fbStats = charCount(fbTeaser, 63206);
  const igStats = charCount(igTeaser, 2200);
        ...
        <div className="card overflow-hidden">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex items-center gap-2 p-2 bg-blue-50 rounded-lg">
              ...
              <span className="text-xs text-blue-700">Link preview auto-generates from Open Graph tags</span>
            </div>
          </div>
        </div>
        ...
        <div className="card overflow-hidden">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex items-center gap-2 p-2 bg-amber-50 rounded-lg">
              <svg className="w-4 h-4 text-amber-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>
