...
export const sites = [
  ...
  { id: "is", name: "Iceland Review", url: "icelandreview.is", status: "active", contentCount: 203, lastPublish: "2024-05-29T14:15:00", health: 96, logo: "IS" },
  ...
  { id: "fo", name: "Faroe Islands Review", url: "faroe review.fo", status: "active", contentCount: 94, lastPublish: "2024-05-26T13:30:00", health: 94, logo: "FO" },
];
...
export const activityFeed = [
  { id: 1, type: "publish", message: "Article published to Iceland Review", user: "Erik Lindqvist", time: "2 minutes ago", article: "Iceland Tourism Surges 23% with New International Routes" },
  ...
  { id: 10, type: "draft", message: "Draft created for Iceland Review", user: "Astrid Karlsen", time: "8 hours ago", article: "Copenhagen Arctic Research Center Opens Climate Lab" },
  ...
  { id: 15, type: "schedule", message: "Content scheduled on Iceland Review", user: "Ingrid Halvorsen", time: "18 hours ago", article: "Finnish Precision Forestry Boosts Yield and Biodiversity" },
  ...
  { id: 20, type: "review", message: "Article approved for Iceland Review", user: "Mikael Nilsen", time: "2 days ago", article: "Swedish Arctic Towns Adapt Infrastructure for Thawing Ground" },
...
// --- Image Sourcing Mock Data ---
export const freeImageSets: Record<string, { id: string; url: string; credit: string; source: string }[]> = {
  Policy: [
    { id: "fp1", url: "https://picsum.photos/seed/policy1/400/250", credit: "Arctic Council Archive", source: "Unsplash" },
    { id: "fp2", url: "https://picsum.photos/seed/policy2/400/250", credit: "Nordic Council Media", source: "Pexels" },
    { id: "fp3", url: "https://picsum.photos/seed/policy3/400/250", credit: "Greenland Gov", source: "Unsplash" },
    { id: "fp4", url: "https://picsum.photos/seed/policy4/400/250", credit: "EU Arctic Forum", source: "Pexels" },
    { id: "fp5", url: "https://picsum.photos/seed/policy5/400/250", credit: "Norwegian Polar Institute", source: "Unsplash" },
    { id: "fp6", url: "https://picsum.photos/seed/policy6/400/250", credit: "Arctic Today", source: "Pexels" },
  ],
  Tourism: [
    { id: "ft1", url: "https://picsum.photos/seed/tour1/400/250", credit: "Visit Iceland", source: "Unsplash" },
    { id: "ft2", url: "https://picsum.photos/seed/tour2/400/250", credit: "Nordic Visitor", source: "Pexels" },
    { id: "ft3", url: "https://picsum.photos/seed/tour3/400/250", credit: "Arctic Adventures", source: "Unsplash" },
    { id: "ft4", url: "https://picsum.photos/seed/tour4/400/250", credit: "Visit Greenland", source: "Pexels" },
    { id: "ft5", url: "https://picsum.photos/seed/tour5/400/250", credit: "Lapland Tourism", source: "Unsplash" },
    { id: "ft6", url: "https://picsum.photos/seed/tour6/400/250", credit: "Faroe Islands Tourism", source: "Pexels" },
  ],
  Environment: [
    { id: "fe1", url: "https://picsum.photos/seed/env1/400/250", credit: "WWF Arctic", source: "Unsplash" },
    { id: "fe2", url: "https://picsum.photos/seed/env2/400/250", credit: "NASA Earth", source: "Pexels" },
    { id: "fe3", url: "https://picsum.photos/seed/env3/400/250", credit: "Arctic Institute", source: "Unsplash" },
    { id: "fe4", url: "https://picsum.photos/seed/env4/400/250", credit: "National Geographic", source: "Pexels" },
    { id: "fe5", url: "https://picsum.photos/seed/env5/400/250", credit: "Greenpeace Nordic", source: "Unsplash" },
    { id: "fe6", url: "https://picsum.photos/seed/env6/400/250", credit: "Arctic Council", source: "Pexels" },
  ],
  Infrastructure: [
    { id: "fi1", url: "https://picsum.photos/seed/inf1/400/250", credit: "Nordic Construction", source: "Unsplash" },
    { id: "fi2", url: "https://picsum.photos/seed/inf2/400/250", credit: "Arctic Engineering", source: "Pexels" },
    { id: "fi3", url: "https://picsum.photos/seed/inf3/400/250", credit: "Barents Observer", source: "Unsplash" },
    { id: "fi4", url: "https://picsum.photos/seed/inf4/400/250", credit: "High North News", source: "Pexels" },
    { id: "fi5", url: "https://picsum.photos/seed/inf5/400/250", credit: "Arctic Portal", source: "Unsplash" },
    { id: "fi6", url: "https://picsum.photos/seed/inf6/400/250", credit: "Nordic Energy", source: "Pexels" },
  ],
  Culture: [
    { id: "fc1", url: "https://picsum.photos/seed/cult1/400/250", credit: "Saami Council", source: "Unsplash" },
    { id: "fc2", url: "https://picsum.photos/seed/cult2/400/250", credit: "Nordic Museum", source: "Pexels" },
    { id: "fc3", url: "https://picsum.photos/seed/cult3/400/250", credit: "Inuit Art Foundation", source: "Unsplash" },
    { id: "fc4", url: "https://picsum.photos/seed/cult4/400/250", credit: "Arctic Arts Summit", source: "Pexels" },
    { id: "fc5", url: "https://picsum.photos/seed/cult5/400/250", credit: "Greenland Culture", source: "Unsplash" },
    { id: "fc6", url: "https://picsum.photos/seed/cult6/400/250", credit: "Nordic Culture Fund", source: "Pexels" },
  ],
  Science: [
    { id: "fs1", url: "https://picsum.photos/seed/sci1/400/250", credit: "Arctic Research", source: "Unsplash" },
    { id: "fs2", url: "https://picsum.photos/seed/sci2/400/250", credit: "Polar Science", source: "Pexels" },
    { id: "fs3", url: "https://picsum.photos/seed/sci3/400/250", credit: "NordForsk", source: "Unsplash" },
    { id: "fs4", url: "https://picsum.photos/seed/sci4/400/250", credit: "Arctic Science", source: "Pexels" },
    { id: "fs5", url: "https://picsum.photos/seed/sci5/400/250", credit: "ESA Arctic", source: "Unsplash" },
    { id: "fs6", url: "https://picsum.photos/seed/sci6/400/250", credit: "Arctic Station", source: "Pexels" },
  ],
  Economy: [
    { id: "fecon1", url: "https://picsum.photos/seed/econ1/400/250", credit: "Arctic Business", source: "Unsplash" },
    { id: "fecon2", url: "https://picsum.photos/seed/econ2/400/250", credit: "Nordic Business", source: "Pexels" },
    { id: "fecon3", url: "https://picsum.photos/seed/econ3/400/250", credit: "High North Economics", source: "Unsplash" },
    { id: "fecon4", url: "https://picsum.photos/seed/econ4/400/250", credit: "Arctic Economic Council", source: "Pexels" },
    { id: "fecon5", url: "https://picsum.photos/seed/econ5/400/250", credit: "Barents Euro-Arctic", source: "Unsplash" },
    { id: "fecon6", url: "https://picsum.photos/seed/econ6/400/250", credit: "Arctic Investment", source: "Pexels" },
  ],
  Technology: [
    { id: "ftech1", url: "https://picsum.photos/seed/tech1/400/250", credit: "Arctic Tech", source: "Unsplash" },
    { id: "ftech2", url: "https://picsum.photos/seed/tech2/400/250", credit: "Nordic Innovation", source: "Pexels" },
    { id: "ftech3", url: "https://picsum.photos/seed/tech3/400/250", credit: "Arctic Startup", source: "Unsplash" },
    { id: "ftech4", url: "https://picsum.photos/seed/tech4/400/250", credit: "Tech North", source: "Pexels" },
    { id: "ftech5", url: "https://picsum.photos/seed/tech5/400/250", credit: "Arctic Data", source: "Unsplash" },
    { id: "ftech6", url: "https://picsum.photos/seed/tech6/400/250", credit: "Polar Tech", source: "Pexels" },
  ],
};

export const aiGeneratedImages: Record<string, { id: string; url: string; prompt: string }[]> = {
  Policy: [
    { id: "aip1", url: "https://picsum.photos/seed/aipolicy1/400/250", prompt: "A dramatic aerial view of an icebreaker ship navigating through crystalline Arctic waters at golden hour, editorial photography, cinematic lighting, ultra-detailed" },
    { id: "aip2", url: "https://picsum.photos/seed/aipolicy2/400/250", prompt: "Modern glass conference hall with flags of Arctic Council member states, diplomats in discussion, warm interior lighting, photojournalistic style" },
    { id: "aip3", url: "https://picsum.photos/seed/aipolicy3/400/250", prompt: "Close-up of signed policy documents on a mahogany desk with Arctic map in background, shallow depth of field, professional editorial" },
  ],
  Tourism: [
    { id: "ait1", url: "https://picsum.photos/seed/aitour1/400/250", prompt: "Aurora borealis dancing over a traditional Icelandic turf house, long exposure photography, vibrant green and purple sky, pristine snow foreground" },
    { id: "ait2", url: "https://picsum.photos/seed/aitour2/400/250", prompt: "Tourists on a glacier hike in Greenland, dramatic ice formations, professional adventure photography, vivid blue ice crevasses" },
    { id: "ait3", url: "https://picsum.photos/seed/aitour3/400/250", prompt: "Cozy Scandinavian cabin with warm light glowing from windows against snowy Nordic landscape, inviting winter tourism scene" },
  ],
  Environment: [
    { id: "aie1", url: "https://picsum.photos/seed/aienv1/400/250", prompt: "Melting glacier calving into turquoise Arctic fjord, climate documentary photography, dramatic scale, vivid ice textures" },
    { id: "aie2", url: "https://picsum.photos/seed/aienv2/400/250", prompt: "Polar bear on diminishing sea ice, powerful environmental portrait, National Geographic style, moody overcast sky" },
    { id: "aie3", url: "https://picsum.photos/seed/aienv3/400/250", prompt: "Scientific monitoring station on vast Arctic tundra, solar panels and sensors, research documentary style, expansive landscape" },
  ],
  Infrastructure: [
    { id: "aii1", url: "https://picsum.photos/seed/aiinf1/400/250", prompt: "Modern Arctic port with cargo ships and cranes against snow-capped mountains, industrial photography, crisp winter light" },
    { id: "aii2", url: "https://picsum.photos/seed/aiinf2/400/250", prompt: "Wind turbines on a Nordic coastal cliff, renewable energy infrastructure, dramatic seascape, professional architectural photography" },
    { id: "aii3", url: "https://picsum.photos/seed/aiinf3/400/250", prompt: "Undersea fiber optic cable landing station in remote Arctic village, technology meets wilderness, documentary style" },
  ],
  Culture: [
    { id: "aic1", url: "https://picsum.photos/seed/aicult1/400/250", prompt: "Traditional Saami reindeer herder in colorful cultural dress against snowy Lapland landscape, cultural portrait photography, respectful documentary" },
    { id: "aic2", url: "https://picsum.photos/seed/aicult2/400/250", prompt: "Greenlandic throat singers performing in traditional costume, intimate cultural photography, warm indoor lighting" },
    { id: "aic3", url: "https://picsum.photos/seed/aicult3/400/250", prompt: "Intricate Inuit soapstone carving being crafted by skilled artisan hands, macro cultural photography, detailed texture" },
  ],
  Science: [
    { id: "ais1", url: "https://picsum.photos/seed/aisci1/400/250", prompt: "Research scientists in polar parkas examining ice core samples in mobile Arctic lab, scientific documentary, clinical lighting" },
    { id: "ais2", url: "https://picsum.photos/seed/aisci2/400/250", prompt: "Satellite dish array on Arctic research station at twilight, technology in extreme environment, professional photography" },
    { id: "ais3", url: "https://picsum.photos/seed/aisci3/400/250", prompt: "Microscopic view of ancient Arctic microorganisms in ice sample, scientific visualization style, vivid false-color detail" },
  ],
  Economy: [
    { id: "aiecon1", url: "https://picsum.photos/seed/aiecon1/400/250", prompt: "Modern Arctic mining operation with heavy machinery on vast tundra, industrial scale photography, dramatic overcast sky" },
    { id: "aiecon2", url: "https://picsum.photos/seed/aiecon2/400/250", prompt: "Fishing vessels unloading catch at Nordic harbor at dawn, commercial fishing industry, golden hour documentary" },
    { id: "aiecon3", url: "https://picsum.photos/seed/aiecon3/400/250", prompt: "Arctic data center exterior with snow-covered landscape, modern tech infrastructure meets wilderness, architectural photography" },
  ],
  Technology: [
    { id: "aitech1", url: "https://picsum.photos/seed/aitech1/400/250", prompt: "Autonomous electric ferry navigating between Norwegian fjord islands, futuristic maritime transport, sleek design photography" },
    { id: "aitech2", url: "https://picsum.photos/seed/aitech2/400/250", prompt: "Drone swarm mapping Arctic terrain, aerial perspective, technology innovation photography, crisp winter light" },
    { id: "aitech3", url: "https://picsum.photos/seed/aitech3/400/250", prompt: "AI-powered fisheries monitoring buoy in rough Atlantic seas, marine technology, dramatic wave action, documentary style" },
  ],
};

export function getAutoPrompt(title: string, category: string): string {
  const base = `A professional editorial photograph illustrating "${title}". `;
  const style = "Style: cinematic, ultra-detailed, photojournalistic quality, suitable for a premium Nordic news publication. ";
  const contexts: Record<string, string> = {
    Policy: "Setting: government building or diplomatic venue. Mood: serious, authoritative, composed.",
    Tourism: "Setting: iconic Nordic landscape or cultural attraction. Mood: inviting, awe-inspiring, vibrant.",
    Environment: "Setting: pristine Arctic wilderness or climate impact zone. Mood: powerful, contemplative, urgent.",
    Infrastructure: "Setting: modern engineering project in extreme environment. Mood: industrial, innovative, resilient.",
    Culture: "Setting: traditional or contemporary Nordic cultural scene. Mood: authentic, warm, respectful.",
    Science: "Setting: research station or field laboratory. Mood: precise, curious, groundbreaking.",
    Economy: "Setting: commercial operation or trade hub. Mood: dynamic, prosperous, forward-looking.",
    Technology: "Setting: cutting-edge tech deployment in Arctic conditions. Mood: futuristic, sleek, robust.",
  };
  return base + style + (contexts[category] || contexts.Policy);
}
...
export const researchTopics: ResearchTopic[] = [
  {
    ...
    contextSummary: "Recent Arctic Council meetings in Tromsø have produced draft regulations for ice-class vessel certification. Norway and Denmark are pushing for stricter standards while Russia prefers voluntary compliance. The policy debate centers on balancing economic access with ecological protection.",
  ...
  {
    id: "rt2",
    title: "Iceland Tourism Surge: Can Infrastructure Keep Pace with 23% Visitor Growth?",
    angle: "Economic Impact",
    contextSummary: "Iceland's tourism board reports unprecedented growth driven by new direct flights from Asia and North America. However, local municipalities report strain on wastewater systems, road capacity, and emergency services. The central government is debating a tourism tax to fund infrastructure.",
    suggestedSite: "Iceland Review",
    confidence: 91,
    sourceCount: 9,
    sources: ["Iceland Tourism Board", "Reykjavik City Council", "Icelandair Press", "Lonely Planet Nordic", "Nordic Business Report"],
    category: "Tourism",
  ...
  },
  {
    ...
    contextSummary: "Greenland's new mineral extraction framework introduces environmental bonds and community consent requirements. Chinese and Australian mining firms are lobbying for exemptions. The policy could make Greenland a major rare earth supplier while protecting indigenous hunting grounds.",
  ...
  },
  {
    ...
    contextSummary: "Denmark's ambitious maritime emission reduction plan requires retrofitting the entire ferry fleet. Analysis of current vessel ages suggests 60% of ships need replacement by 2028. Alternative fuel infrastructure at Copenhagen, Aarhus, and Odense ports is insufficient for the timeline.",
  ...
  },
  {
    ...
    contextSummary: "The world's largest sovereign wealth fund announced complete divestment from Barents Sea exploration licenses. The move affects 14 active licenses and signals a strategic pivot to offshore wind and carbon capture investments. Stakeholder reactions range from applause to legal threats.",
    suggestedSite: "Norway Review",
    confidence: 92,
    sourceCount: 11,
  ...
  },
  {
    ...
    contextSummary: "New research from Luleå University reveals permafrost thaw rates 40% faster than IPCC models predicted. The findings threaten 340km of roads, 12 bridges, and railway foundations in northern Sweden. Municipal engineers are calling for emergency adaptation funding.",
  ...
  },
  {
    ...
    contextSummary: "Finland's new Arctic university exchange program connects 14 institutions across the Nordics. The initiative focuses on cold climate engineering, sustainable resource management, and indigenous knowledge systems. Initial enrollment exceeds projections by 200%.",
  ...
  },
  {
    ...
    contextSummary: "The Faroe Islands deployed an AI-assisted fisheries tracking system using satellite AIS, underwater acoustic sensors, and machine learning. Early results show 30% reduction in bycatch and 15% improvement in quota accuracy. Other North Atlantic nations are requesting technology transfers.",
...
export const monitoredSources = [
  ...
  { id: "ms9", name: "Iceland Tourism Board", type: "site", status: "active", lastScan: "30 min ago", articlesFound: 24 },
  { id: "ms10", name: "EU Arctic Policy Feed", type: "feed", status: "maintenance", lastScan: "1 hour ago", articlesFound: 18 },
];


// AI Image Generation & Free Stock
...
export const researchSources = [
  ...
  },
  {
    ...
    status: "parsed",
    topicsExtracted: 6,
    summary: "Quarterly tourism data across Denmark, Norway, Sweden, Finland, Iceland showing 23% increase in Arctic region visitors with infrastructure strain analysis.",
  },
  {
    id: "rs-4",
    type: "url" as const,
...
export const monitoredArticles = [
  ...
  {
    id: "mon-2",
    title: "Iceland Volcanic Activity Threatens Airport Operations",
    source: "Iceland Review",
    url: "https://icelandreview.com/volcano-2024",
...
export const generatedTopics = [
  {
    ...
    urgency: "high",
    excerpt: "With the Arctic Council's new shipping safety summit concluding in Tromsø, operators face updated ice-class certification requirements and mandatory satellite tracking protocols. This article breaks down the compliance timeline and cost implications for the 40% traffic increase on Northern Sea Routes.",
  ...
  },
  {
    ...
    urgency: "medium",
    excerpt: "Greenland's new mineral extraction policy introduces strict oversight for rare earth mining in sensitive regions. We examine the balance between economic sovereignty and environmental stewardship, featuring interviews with geologists and conservation advocates.",
  ...
  {
    id: "gt-3",
    title: "Iceland Tourism Boom: Can Infrastructure Keep Pace with 23% Visitor Surge?",
    sourceIds: ["rs-3"],
    monitorIds: ["mon-2"],
    confidence: 95,
    category: "Tourism",
    ...
    urgency: "high",
    excerpt: "New direct flights from North America and Asia have driven unprecedented visitor numbers. But with Reykjavik hotels at 94% capacity and volcanic activity disrupting Keflavik operations, is Iceland's tourism infrastructure approaching a breaking point?",
    keywords: ["Iceland tourism", "infrastructure strain", "Keflavik airport", "volcanic disruption", "visitor capacity"],
  ...
  },
  {
    ...
    urgency: "medium",
    excerpt: "Three new offshore wind parks will add capacity for 2.5 million homes. We analyze the engineering challenges, supply chain logistics, and what this means for Denmark's 2030 carbon neutrality pledge.",
  ...
  },
  {
    ...
    urgency: "low",
    excerpt: "As the seed vault accepts its 1.2 millionth deposit from 87 nations, we explore the facility's role as humanity's backup plan—and the Arctic researchers working to make crop diversity future-proof.",
  ...
  },
  {
    ...
    urgency: "medium",
    excerpt: "Warmer winters are disrupting the Arctic fox's seasonal camouflage. Combined with shifting seabird populations in the Faroes, the Arctic food web is undergoing rapid transformation documented by researchers.",
  ...
  },
  {
    ...
    wordCountEstimate: 1200,
    urgency: "medium",
    excerpt: "With expanded youth forums and new corporate partnership tiers, this year's Reykjavik assembly reflects the Arctic's transition from scientific preserve to economic frontier. Who gets a seat at the table?",
